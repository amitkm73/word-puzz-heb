...
function Header(props) {
  return (
    <header>
      <div className="menu">
      <button id="help-button" className="icon" aria-label="help" onClick={props.handleUsage}>
        <game-icon icon="help">
      ...
      <button id="settings-button" className="icon" aria-label="settings" onClick={props.handleSettings}>
